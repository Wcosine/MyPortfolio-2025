...
<template>
  ...
  <Header
    ...
    content="我正在轉職為前端工程師，熟悉HTML、CSS，並正在持續學習Vue與JavaScript。我是一個對自己要求高、學習動機強的人，目前每天紀錄前端練習進度，已經維持有80天。透過每日更新不僅督促自己持續學習，也意外獲得一些前輩回饋，讓我更有成長動力。這段過程我發現自己在學習新知識、探索新領域時會感到興奮。這些經驗讓我意識到自己是一個擅長長期投入、熱愛學習的人。"
